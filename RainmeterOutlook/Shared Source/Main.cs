...
namespace OutlookPlugin
{
    public class Main
    {
        ...
        // *** WARNING / NOTES ***
        //
        // Do not add to this code:  change your code in OutlookPlugin.cs instead
        //
...
//        }
        ...
        {
            // Do not modify this member.  Instead, update your code in 'OutlookPlugin.cs'.
            return Rainmeter.String(new YourPlugin().GetString(Plugin, id));
        }

        #endregion

        #region ExecuteBang() export -- no need to modify (change code in OutlookPlugin.cs)
