...
//
// Rather, most of your plugin's code should go in OutlookPlugin.cs or additional files
...
namespace OutlookPlugin
{
    ...
    public class YourPlugin
    {
        ...
        // This class is a simple launcher for your actual code in OutlookPlugin.cs
        //
        ...
        private class UpdateThread
        {
            ...
            public void Go()
            {
                ...
                try
                {
                    this.Instance.SetTempValue("__RMT_U_LastValue", new OutlookPlugin().Update(this.Instance));
                }
                catch (Exception ex)
                {
        ...
        private class GetStringThread
        {
            ...
            public void Go()
            {
                ...
                try
                {
                    this.Instance.SetTempValue("__RMT_GS_LastValue", new OutlookPlugin().GetString(this.Instance));
                }
                catch (Exception ex)
                {
                    Rainmeter.Log(Rainmeter.LogLevel.Error, "C# plugin in GetString(), " + ex.GetType().ToString() + ": " + ex.Message);
